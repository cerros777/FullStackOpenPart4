...
const config = require('./utils/config')  // Adjust the path to your config file
const logger = require('./utils/logger')  // Adjust the path to your logger file
...
const addDefaultUserToBlogs = async () => {
  try {
    ...
    const defaultUser = await User.findOne() // Fetch an existing user to set as the default user
